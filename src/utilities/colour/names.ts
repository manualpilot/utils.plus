import { toOklab, type Vector } from "./spaces";
...
export const NAMED_HEX = new Map<string, number>();
export const HEX_NAMES = new Map<number, string>();
...
export function namedOklab(): [string, Vector][] {
