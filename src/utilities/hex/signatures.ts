...
const SIGNATURES: Signature[] = [
  ...
  { label: "AVIF image", at: 4, magic: ascii("ftypavif") },
  { label: "AVIF image sequence", at: 4, magic: ascii("ftypavis") },
  { label: "HEIC image", at: 4, magic: ascii("ftypheic") },
  { label: "HEIC image", at: 4, magic: ascii("ftypheix") },
  { label: "HEIC image sequence", at: 4, magic: ascii("ftyphevc") },
  { label: "HEIC image sequence", at: 4, magic: ascii("ftyphevx") },
  { label: "HEIF image", at: 4, magic: ascii("ftypmif1") },
  { label: "HEIF image sequence", at: 4, magic: ascii("ftypmsf1") },
